...
const OtherUserProfile = () => {
  ...
  return (
    <div className='bg-gray-100 flex flex-col w-[70%] min-h-screen ml-[22%]'>
        ...
        {
            gettindData ? <div className='w-full h-full flex items-center justify-center '>
                 <Loading/>
            </div> : 
            <div className='p-4 flex border-b'>
            <div className='px-4 py-3 ml-10'>
                <img src={otherUser?.profilePic} className="w-[150px] object-cover h-[150px] rounded-full" alt="" />
            </div>
        ...
        {isFetching ? <div className='w-full h-full flex items-center justify-center '>
                 <Loading/>
            </div> 
         : <>
         <div className='relative ml-[23.5rem]'>
            <div className='  p-4 gap-16 flex'>
                <div onClick={()=>setToggleTabs(true)} className=' transition-all flex cursor-pointer items-center gap-1 '>
                 ...
                 <div className='absolute  transition-all  -top-5 left-[0.3rem]'>
                    ___________
                </div> 
         ...
         <div className='ml-[1rem]  transition-all '>
